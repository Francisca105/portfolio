    ...
    <div className="container px-4 py-12 md:py-24">
      <section className="flex flex-col items-start gap-6 max-w-[800px]">
        ...
        <p className="text-xl text-muted-foreground leading-relaxed">
          Full-Stack Software Engineer based in Lisbon. I specialize in building
          scalable systems with
          <span className="text-foreground font-medium"> Java</span>,
          <span className="text-foreground font-medium"> Next.js</span>, and
          <span className="text-foreground font-medium"> FastAPI</span>. Focused
          on automation, performance, and clean architecture.
        </p>
        ...
        <div className="flex gap-4 pt-4 text-muted-foreground">
          ...
          <a
            href="https://linkedin.com/in/francisca105"
            target="_blank"
            rel="noopener noreferrer"
            className="hover:text-foreground transition-colors"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm">
            ...
            <p className="text-sm text-muted-foreground">
              Designing robust APIs and microservices using Java (Spring Boot)
              and Python (FastAPI).
            </p>
          </div>
          <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm">
            ...
            <p className="text-sm text-muted-foreground">
              Crafting performant, accessible user interfaces with React,
          ...
          <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm">
            ...
            <p className="text-sm text-muted-foreground">
              Optimizing CI/CD pipelines and focusing on clean, maintainable
              code standards.
            </p>
          </div>
        </div>
